            ...
            get
            {
                try
                {
                    ...
                    if (inst == null)
                    {
                        ...
                        return System.Web.HttpContext.Current.Session["SessionUsuario"] as AsistenteMatricula.Portal.GestionarReporteService.UniversidadUsuario;
                }
                catch (Exception)
                {
                    HttpContext.Current.Response.StatusCode = 401;
